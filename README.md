...
To start the development server run `nx serve jam-next`. Open your browser and navigate to http://localhost:4200/. Happy coding!

## Useful scripts

- `npm run db`: to start your backend
- `npm run start`: serving app in dev mode
- `npm run build`: executing production build
- `npx nx run jam-next:serve:production`: to run your next.js production server
